...
function ricoman_settings_defaults() {
	return array(
		...
		'mega_card1_img'   => get_theme_file_uri( 'assets/images/rico-soundslikelight.png' ),
		...
		'foot_col_other'   => "News | /\nDownloads | /downloads/\nHuman Centric Lighting | /lighting-design/\nProduct Warranty | /about/",
		'foot_legal'       => "Terms & Conditions | /\nCookie Policy | /\nPrivacy Policy | /\nSite Map | /",
		'code_head'        => '',
		'code_body_open'   => '',
		'code_footer'      => '',
	);
