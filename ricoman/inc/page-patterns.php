...
add_action( 'init', function () {
	...
	$p['custom-intro'] = array( 'Customisation · Intro', $sec( $twocol( $eyebrow( 'Made to your spec' ) . $shead( 'Bespoke as standard' ) . $para( 'Tell us the geometry, the look and the performance you need. Our in-house design and manufacturing teams turn it into a buildable, costed luminaire — made to order on an average six-day UK lead.', true ) . $buttons( $btn( 'Design a Flow+ run →', '/flow-designer/' ) . $btn( 'Talk to our designers', '/contact/', false ) ), $image( $u( 'rico-betfred-flow.jpg' ) ) ) ) );
