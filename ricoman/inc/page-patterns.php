...
add_action( 'init', function () {
	...
	$image   = function ( $url, $href = '', $alt = '' ) { $i = '<img src="' . $url . '" alt="' . esc_attr( $alt ) . '"/>'; if ( $href ) { return '<!-- wp:image {"linkDestination":"custom"} --><figure class="wp-block-image size-large"><a href="' . $href . '">' . $i . '</a></figure><!-- /wp:image -->'; } return '<!-- wp:image {"sizeSlug":"large"} --><figure class="wp-block-image size-large">' . $i . '</figure><!-- /wp:image -->'; };
