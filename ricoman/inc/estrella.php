...
function ricoman_estrella_styles() {
	...
	return '<style>'
		...
		. '.rm-es-range .rm-eyebrow{text-transform:uppercase;letter-spacing:.12em;font-size:.78rem;font-weight:700;color:#946c1c;margin:0 0 .4em}'
		...
		. '.rm-es-ometrics dt{font-size:.66rem;text-transform:uppercase;letter-spacing:.06em;color:#5b6270;margin:0}'
		...
		. '.rm-es-finish strong{font-size:.95rem}.rm-es-finish span{color:#5b6270;font-size:.85rem;margin-left:auto}'
		...
		. '.rm-es-specrow dt{color:#5b6270;font-size:.85rem;margin:0}'
