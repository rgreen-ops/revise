...
add_action( 'init', function () {
	...
	$p['flow-hero'] = array( 'Flow · Hero', $cover( $u( 'bf-flow3.png' ),
	...
	$p['flow-feature-2'] = array( 'Flow · Feature (image right)', $sec( $cols(
		...
		'<!-- wp:column {"verticalAlignment":"center"} --><div class="wp-block-column is-vertically-aligned-center">' . $image( $u( 'bf-flow3.png' ) ) . '</div><!-- /wp:column -->',
		'{"verticalAlignment":"center"}' ) ) );
	...
	$p['flow-specband'] = array( 'Flow · Spec band', $cover( $u( 'bf-flow3.png' ),
