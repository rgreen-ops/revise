...
add_action( 'init', function () {
	...
	$p['flow-team'] = array( 'Flow · Design team', $sec( $eyebrow( '06 · Lighting Design' ) . $shead( 'Our in-house design team, on your project' ) . $para( 'Our UK lighting designers work alongside architects, interior designers and contractors to take a scheme from concept to commissioning — complimentary on commercial projects.', true ) .
...
function ricoman_flow_product_blocks() {
	$stack = array( 'flow-hero', 'flow-facts', 'flow-statement', 'flow-feature-1', 'flow-feature-2', 'flow-manufacturing', 'flow-custom', 'flow-opportunities', 'flow-team', 'flow-specband', 'product-range', 'product-specs-live', 'product-why', 'flow-mosaic', 'flow-quote', 'flow-cta' );
	$out   = '';
