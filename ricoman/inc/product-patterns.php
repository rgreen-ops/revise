...
<!-- /wp:cover -->' );
	...
	$_img_col  = '<!-- wp:column {"verticalAlignment":"center"} --><div class="wp-block-column is-vertically-aligned-center"><!-- wp:image {"sizeSlug":"full"} --><figure class="wp-block-image size-full"><img src="' . $u( 'ceiling.webp' ) . '" alt=""/></figure><!-- /wp:image --></div><!-- /wp:column -->';
	$_txt_l    = '<!-- wp:column {"verticalAlignment":"center","style":{"spacing":{"padding":{"left":"var:preset|spacing|50"}}}} --><div class="wp-block-column is-vertically-aligned-center" style="padding-left:var(--wp--preset--spacing--50)"><!-- wp:heading {"level":2,"style":{"typography":{"fontWeight":"600","lineHeight":"1.1"}}} --><h2 class="wp-block-heading" style="font-weight:600;line-height:1.1">Your headline goes here.</h2><!-- /wp:heading --><!-- wp:paragraph {"style":{"color":{"text":"#a0a0a0"}}} --><p class="has-text-color" style="color:#a0a0a0">Describe the key feature or benefit here. Replace this with your product copy.</p><!-- /wp:paragraph --></div><!-- /wp:column -->';
	$_txt_r    = '<!-- wp:column {"verticalAlignment":"center","style":{"spacing":{"padding":{"right":"var:preset|spacing|50"}}}} --><div class="wp-block-column is-vertically-aligned-center" style="padding-right:var(--wp--preset--spacing--50)"><!-- wp:heading {"level":2,"style":{"typography":{"fontWeight":"600","lineHeight":"1.1"}}} --><h2 class="wp-block-heading" style="font-weight:600;line-height:1.1">Your headline goes here.</h2><!-- /wp:heading --><!-- wp:paragraph {"style":{"color":{"text":"#a0a0a0"}}} --><p class="has-text-color" style="color:#a0a0a0">Describe the key feature or benefit here. Replace this with your product copy.</p><!-- /wp:paragraph --></div><!-- /wp:column -->';
	$_cols_hd  = '<!-- wp:group {"align":"full","className":"rm-section","layout":{"type":"constrained"}} --><div class="wp-block-group alignfull rm-section"><!-- wp:columns {"verticalAlignment":"center"} --><div class="wp-block-columns are-vertically-aligned-center">';
	$_cols_ft  = '</div><!-- /wp:columns --></div><!-- /wp:group -->';
	$p['product-mediapanel']     = array( 'Product · Media panel (image / video left)',  $_cols_hd . $_img_col . $_txt_l . $_cols_ft );
	$p['product-mediapanel-rev'] = array( 'Product · Media panel (image / video right)', $_cols_hd . $_txt_r . $_img_col . $_cols_ft );
