...
add_action( 'init', function () {
	...
	$img     = function ( $url, $alt = '' ) { return '<!-- wp:image {"sizeSlug":"large"} --><figure class="wp-block-image size-large"><img src="' . $url . '" alt="' . esc_attr( $alt ) . '" loading="lazy" decoding="async"/></figure><!-- /wp:image -->'; };
