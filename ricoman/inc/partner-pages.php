...
.prodgrid .more{display:none}
.prodgrid.open .more{display:block}
...
<section class="pad" style="padding-top:0"><div class="wrap">
	...
	<div class="cap">
		<a href="<?php echo esc_url( home_url( '/products/sounds-like-light-baffle/' ) ); ?>"><img loading="lazy" src="<?php echo esc_url( home_url( '/wp-content/uploads/2026/08/Acoustic_Light_Baffles_Betfred-800x532.webp' ) ); ?>" alt="Sounds Like Light acoustic baffles at Betfred"></a>
		<div>
...
<section class="pad" style="padding-top:0"><div class="wrap">
	...
	<div class="prodgrid" id="prodgrid">
		...
		<a class="more" href="<?php echo esc_url( home_url( '/products/surface-mounted-ip65-downlight-modus/' ) ); ?>"><figure><img loading="lazy" src="<?php echo $img( 'office3.webp' ); ?>" alt="Ricoman Modus surface IP65 downlight"><figcaption><span class="pt">Modus</span><span class="ps">Surface IP65 downlight</span></figcaption></figure></a>
		<a class="more" href="<?php echo esc_url( home_url( '/products/sounds-like-light-harmony-pendant/' ) ); ?>"><figure><img loading="lazy" src="<?php echo $img( 'rico-breakout-lounge.webp' ); ?>" alt="Ricoman Sounds Like Light Harmony acoustic pendant"><figcaption><span class="pt">Harmony</span><span class="ps">Acoustic pendant</span></figcaption></figure></a>
		<a class="more" href="<?php echo esc_url( home_url( '/products/surface-cellular-downlight/' ) ); ?>"><figure><img loading="lazy" src="<?php echo $img( 'rico-office-render.webp' ); ?>" alt="Ricoman surface cellular downlight"><figcaption><span class="pt">Cellular</span><span class="ps">Low-glare surface downlight</span></figcaption></figure></a>
		<a class="more" href="<?php echo esc_url( home_url( '/products/zodiac-linear-zodiac-cylindrical-pendant/' ) ); ?>"><figure><img loading="lazy" src="<?php echo $img( 'estrella-canteen.webp' ); ?>" alt="Ricoman Zodiac cylindrical pendant"><figcaption><span class="pt">Zodiac pendant</span><span class="ps">Cylindrical pendant</span></figcaption></figure></a>
	</div>
...
<script>
(function(){var b=document.getElementById('rangeMore'),g=document.getElementById('prodgrid');if(!b||!g)return;b.addEventListener('click',function(){var open=g.classList.toggle('open');b.textContent=open?'Show fewer':'See more products';});})();
</script>
</body>
</html>
<?php
