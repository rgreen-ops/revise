...
<section class="pad" style="padding-top:0"><div class="wrap">
	...
	<div class="prodgrid" id="prodgrid">
		...
		<a class="more" href="<?php echo esc_url( home_url( '/products/surface-mounted-ip65-downlight-modus/' ) ); ?>"><figure><img loading="lazy" src="<?php echo esc_url( home_url( '/wp-content/uploads/2026/08/Modus-10.webp' ) ); ?>" alt="Ricoman Modus surface IP65 downlight"><figcaption><span class="pt">Modus</span><span class="ps">Surface IP65 downlight</span></figcaption></figure></a>
		<a class="more" href="<?php echo esc_url( home_url( '/products/sounds-like-light-harmony-pendant/' ) ); ?>"><figure><img loading="lazy" src="<?php echo esc_url( home_url( '/wp-content/uploads/2026/08/IMG_0607-CMYK.webp' ) ); ?>" alt="Ricoman Sounds Like Light Harmony acoustic pendant"><figcaption><span class="pt">Harmony</span><span class="ps">Acoustic pendant</span></figcaption></figure></a>
		<a class="more" href="<?php echo esc_url( home_url( '/products/e-pro-recessed-square/' ) ); ?>"><figure><img loading="lazy" src="<?php echo esc_url( home_url( '/wp-content/uploads/2022/08/RICOMAN-Lighting-product-e-pro-surface06.png' ) ); ?>" alt="Ricoman E-Pro downlight"><figcaption><span class="pt">E-Pro</span><span class="ps">Surface &amp; recessed</span></figcaption></figure></a>
		<a class="more" href="<?php echo esc_url( home_url( '/products/zodiac-48v-direct-track/' ) ); ?>"><figure><img loading="lazy" src="<?php echo esc_url( home_url( '/wp-content/uploads/2023/07/RICOMAN-Lighting-round1.jpg' ) ); ?>" alt="Ricoman Zodiac 48V magnetic track"><figcaption><span class="pt">Zodiac 48V</span><span class="ps">Magnetic track</span></figcaption></figure></a>
	</div>
