...
<section class="pad" style="padding-top:0"><div class="wrap">
	...
	<div class="prodgrid" id="prodgrid">
		...
		<a class="more" href="<?php echo esc_url( home_url( '/product-category/led-linear-lighting/' ) ); ?>"><figure><img loading="lazy" src="<?php echo $img( 'rico-proline-breakout.webp' ); ?>" alt="Ricoman recessed and surface linear profiles"><figcaption><span class="pt">Proline linear</span><span class="ps">Recessed &amp; surface profiles</span></figcaption></figure></a>
		...
		<a class="more" href="#biophilic"><figure><img loading="lazy" src="<?php echo $img( 'biophilic-tree.webp' ); ?>" alt="Ricoman biophilic light trees"><figcaption><span class="pt">Biophilic trees</span><span class="ps">Living light features</span></figcaption></figure></a>
