...
<!-- wp:html -->
<section class="hero">
  <div class="bg" style="background-image:url(<?php echo $img( 'warm-int.webp' ); ?>)"></div><div class="scrim"></div>
  <div class="inner">
...
<section class="sec" style="padding-top:0"><div class="wrap">
  ...
  <div class="range">
    <a class="rcard" href="/products/"><div class="ph"><img src="<?php echo $img( 'arch-line.webp' ); ?>" alt="Linear lighting"></div><div class="meta"><h3>Linear Lighting</h3><span class="ar">→</span></div><div class="sub">Continuous runs &amp; profile systems</div></a>
    <a class="rcard" href="/products/"><div class="ph"><img src="<?php echo $img( 'ceiling.webp' ); ?>" alt="Downlights"></div><div class="meta"><h3>Downlights</h3><span class="ar">→</span></div><div class="sub">Fire-rated, switchable CCT</div></a>
    <a class="rcard" href="/products/"><div class="ph"><img src="<?php echo $img( 'pendant.webp' ); ?>" alt="Pendants"></div><div class="meta"><h3>Pendants</h3><span class="ar">→</span></div><div class="sub">Architectural &amp; decorative</div></a>
    <a class="rcard" href="/products/"><div class="ph"><img src="<?php echo $img( 'retail.webp' ); ?>" alt="Track &amp; spotlights"></div><div class="meta"><h3>Track &amp; Spotlights</h3><span class="ar">→</span></div><div class="sub">Retail &amp; gallery accent</div></a>
    <a class="rcard" href="/products/"><div class="ph"><img src="<?php echo $img( 'warm-int.webp' ); ?>" alt="Biophilic lighting"></div><div class="meta"><h3>Biophilic Lighting</h3><span class="ar">→</span></div><div class="sub">Human-centric, tunable</div></a>
    <a class="rcard" href="/products/"><div class="ph"><img src="<?php echo $img( 'office3.webp' ); ?>" alt="Modular recessed"></div><div class="meta"><h3>Modular Recessed</h3><span class="ar">→</span></div><div class="sub">Offices, schools, healthcare</div></a>
  </div>
</div></section>
...
<section class="feat">
  ...
  <div class="img" style="background-image:url(<?php echo $img( 'ceiling.webp' ); ?>)"></div>
</section>
...
<section class="sec projects"><div class="wrap">
  ...
  <div class="grid">
    <a class="pj big" href="/projects/allianz-hq/"><img src="<?php echo $img( 'office1.webp' ); ?>" alt="Workplace"><div class="ov"><small>Commercial Office · Leeds</small><h3>Allianz HQ Fit-out</h3></div></a>
    <a class="pj wide" href="/projects/flagship-store/"><img src="<?php echo $img( 'retail.webp' ); ?>" alt="Retail"><div class="ov"><small>Retail · Manchester</small><h3>Flagship Store</h3></div></a>
    <a class="pj" href="/projects/studio-hq/"><img src="<?php echo $img( 'office6.webp' ); ?>" alt="Workplace"><div class="ov"><small>Workplace</small><h3>Studio HQ</h3></div></a>
    <a class="pj" href="/projects/boutique-hotel/"><img src="<?php echo $img( 'office2.webp' ); ?>" alt="Hospitality"><div class="ov"><small>Hospitality</small><h3>Boutique Hotel</h3></div></a>
  </div>
</div></section>
...
<section class="dark"><div class="britain">
  ...
  <div class="img" style="background-image:url(<?php echo $img( 'workshop.webp' ); ?>)"></div>
</div></section>
